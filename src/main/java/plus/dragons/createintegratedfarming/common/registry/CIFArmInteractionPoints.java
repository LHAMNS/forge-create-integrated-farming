...
public class CIFArmInteractionPoints {
    ...
    /** Public API: register a custom ArmInteractionPointType for other mods. */
    public static RegistryObject<ArmInteractionPointType> register(String name, Supplier<? extends ArmInteractionPointType> supplier) {
